  ...
  return (
    <div className="container-aboutUs">
      ...
      <aside className="container-categories">
        <Categories number={1} title="Track company-wide progress">
          See how your day-to-day tasks fit into the wider vision. Go from
          tracking progress at the milestone level all the way done to the
          smallest of details. Never lose sight of the bigger picture again.
        </Categories>
        <Categories number={2} title="Advanced built-in reports">
          Set internal delivery estimates and track progress toward company
          goals. Our customisable dashboard helps you build out the reports you
          need to keep key stakeholders informed.
        </Categories>
        <Categories number={3} title="Everything you need in one place">
